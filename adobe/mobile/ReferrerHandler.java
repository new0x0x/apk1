...
final class ReferrerHandler {
    ...
    protected static void handleGooglePlayAcquisition(HashMap<String, Object> hashMap) {
        ...
        if (!z) {
            ...
            try {
                ...
                jSONObject.put("googleReferrerData", new JSONObject(appendNamespaceToGoogleReferrerFields));
    ...
    protected static HashMap<String, Object> parseGoogleReferrerFields(String str) {
        ...
        try {
            hashMap.putAll(getDataFromJSON(new JSONObject(str), "googleReferrerData"));
    ...
    protected static HashMap<String, Object> parseOtherReferrerFields(String str) {
        ...
        try {
            hashMap.putAll(getDataFromJSON(new JSONObject(str), "otherReferrerData"));
        } catch (JSONException e) {
    ...
    protected static String processReferrerDataFromV3Server(String str) {
        ...
        try {
            ...
            HashMap<String, Object> dataFromJSON = getDataFromJSON(jSONObject, "adobeData");
    ...
    protected static HashMap<String, Object> processV3ResponseAndReturnAdobeData(String str) {
        HashMap<String, Object> hashMap = new HashMap<>();
        try {
            HashMap<String, Object> dataFromJSON = getDataFromJSON(new JSONObject(str), "adobeData");
            if (dataFromJSON != null && dataFromJSON.size() > 0) {
    ...
    protected static void handleV3Acquisition(HashMap<String, Object> hashMap) {
        ...
        if (Lifecycle.lifecycleHasRun) {
            ...
            HashMap<String, Object> dataFromJSON = getDataFromJSON(translateV3StringResponseToJSONObject, "contextData");
    ...
    protected static HashMap<String, Object> parseV3ContextDataFromResponse(String str) {
        return getDataFromJSON(translateV3StringResponseToJSONObject(str), "contextData");
    }
    ...
    protected static String getDeepLinkFromJSON(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        try {
