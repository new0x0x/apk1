...
final class MessageLocalNotification extends Message {
    ...
    public void show() {
        ...
        try {
            ...
            try {
                ((AlarmManager) StaticMethods.getSharedContext().getSystemService("alarm")).set(0, instance.getTimeInMillis(), PendingIntent.getBroadcast(StaticMethods.getSharedContext(), nextInt, intent, 134217728));
